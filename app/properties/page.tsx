...
function PropertiesDashboard() {
  ...
  const propertyTypes = [
    { name: "Apartment", icon: <Building2 className="h-4 w-4" /> },
    { name: "House", icon: <Home className="h-4 w-4" /> },
    { name: "Villa", icon: <TreePine className="h-4 w-4" /> },
    { name: "Plot", icon: <Layers className="h-4 w-4" /> },
    { name: "Commercial", icon: <Store className="h-4 w-4" /> },
  ];
            ...
            {isFiltersExpanded && (
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  {/* Status */}
                  <div>
                    <h3 className="font-semibold mb-3 text-sm">Listing Status</h3>
                  ...
                  {/* Bedrooms */}
                  <div>
                    <h3 className="font-semibold mb-3 text-sm">Bedrooms</h3>
                    <div className="flex flex-wrap gap-2">
                      {["Any", "1", "2", "3", "4", "5+"].map((b) => (
                        <Button
                          key={b}
                          variant={bedrooms === (b === "Any" ? "" : b) ? "default" : "outline"}
                          size="sm"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                  {/* Area Range */}
                  <div>
                    <h3 className="font-semibold mb-3 text-sm">Area (sq.ft)</h3>
                    <div className="space-y-3">
                      <Slider
                        min={0}
                        max={10000}
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-xs text-gray-600">
                                {property.ownerName?.split(" ")[0] || "Verified Owner"}
                              </span>
                            </div>
