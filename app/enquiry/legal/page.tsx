...
export default function LegalConsultancyPage() {
  ...
  const stats = [
    ...
    { value: "500+", label: t.SatisfiedClients, icon: Users, color: "from-purple-500 to-pink-500" },
    { value: "100%", label: t.LegalCompliance, icon: Shield, color: "from-green-500 to-emerald-500" },
    { value: "24/7", label: t.SupportAvailable, icon: Clock, color: "from-orange-500 to-red-500" },
  ];
        ...
        <section className="py-24 bg-gradient-to-b from-gray-50 to-white">
          <div className="container px-4 mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-600">
                {t.Comprehensivelegalsolutionsforallyourpropertyneeds}
              </p>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              >
                <div>
                  ...
                  <p className="text-lg text-gray-600">
                    {t.Fillouttheformandourlegalexpertswillgetbacktoyouwithin24hours}
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4 p-4 bg-white rounded-xl shadow-sm">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">{t.EmailAddress}</p>
                      <a href="mailto:info@saraswatinagri.com" className="text-gray-600 hover:text-primary transition-colors">
                  ...
                  <div className="flex items-start gap-4 p-4 bg-white rounded-xl shadow-sm">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">{t.OfficeAddress}</p>
                      <p className="text-gray-600">
                        302, Sai Shraddha Appt., Behind White House Bungalow,<br />
                        Utkarsh Society, Dabha-Wadi Road, Nagpur - 440023
                      </p>
                ...
                {/* Why Choose Us Preview */}
                <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl p-6">
                  <h3 className="text-xl font-bold mb-4 text-gray-900">{t.WhyChooseUs}</h3>
                  <div className="grid grid-cols-2 gap-4">
                    {stats.slice(0, 3).map((stat, index) => {
                      const Icon = stat.icon;
                      return (
              ...
              >
                <div className="bg-gradient-to-r from-primary to-primary/70 p-6">
                  <h3 className="text-2xl font-bold text-white">{t.RequestaConsultation}</h3>
                  <p className="text-primary-foreground/90 mt-2">{t.Fillinyourdetailsandwellgetbacktoyou}</p>
                </div>
                ...
                <form className="p-8 space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="requredService" className="text-gray-700 font-medium">
                      {t.ServiceRequired} <span className="text-red-500">*</span>
                    </Label>
                    <select
                      id="requredService"
                      name="requredService"
                  ...
                  <AnimatePresence>
                    {submitStatus === "success" && (
                      <motion.div
                        ...
                        className="p-4 bg-green-50 border border-green-200 rounded-lg text-green-700 text-sm"
                      >
                        {t.EnquirysubmittedsuccessfullyWellcontactyousoon}
                      </motion.div>
                    )}
        ...
        <section className="py-20 bg-gray-50">
          <div className="container px-4 mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">{t.WhatOurClientsSay}</h2>
              <p className="text-lg text-gray-600">{t.Trustedbyhundredsofsatisfiedclients}</p>
            </motion.div>
        ...
        <section className="py-20">
          <div className="container px-4 mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                {t.Getexpertlegaladviceforyourpropertymatterstoday}
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" variant="outline" className="text-lg px-8">
                  {t.CallNow}: +91 94949 42894
                </Button>
              </div>
            </motion.div>
          </div>
